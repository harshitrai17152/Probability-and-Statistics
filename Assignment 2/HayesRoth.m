...
input_train=attributes(1:118,:);
input_test=attributes(119:n_row,:);
output_train=classes(1:118,1);
output_test=classes(119:n_row,1);
...
for i=1:max(size(input_test))
    ...
    if (three_prob>two_prob) && (three_prob>one_prob)
       class(i,1)=30; 
    end
end
